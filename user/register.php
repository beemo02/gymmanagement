          ...
          <form action="register.php" method="POST">
            <div class="row gy-3 gy-md-4 overflow-hidden">
              <div class="col-12">
                ...
                <input type="email" class="form-control" name="first_name" id="firstName" placeholder="First Name" required>
              </div>
              <div class="col-12">
                <label for="last_name" class="form-label">Last Name <span class="text-danger">*</span></label>
                <input type="email" class="form-control" name="last_name" id="lastName" placeholder="Last Name" required>
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                <label for="created_at" class="form-label">Created At <span class="text-danger">*</span></label>
                <input type="date" class="form-control" name="created_at" id="created_at" value="" required>
              </div>
              <div class="col-12">
